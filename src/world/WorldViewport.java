 ...
 * relative to JComponent gridPosition : the windowPosition without translating
 * ( offset ).
 *
...
public class WorldViewport implements Viewport {
	...
	/**
	 * if the grid is wheeled will zoom and maintain the cursor
	 * windowPosition relative to grid.
	 *
